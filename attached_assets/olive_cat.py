...
def load_olive_cat_image():
    ...
    # Cat whiskers
    pygame.draw.line(fallback, (250, 250, 250), (8, 22), (15, 21), 1)  # Left whisker
    pygame.draw.line(fallback, (250, 250, 250), (8, 24), (15, 24), 1)  # Left whisker
    pygame.draw.line(fallback, (250, 250, 250), (25, 21), (32, 22), 1)  # Right whisker
    pygame.draw.line(fallback, (250, 250, 250), (25, 24), (32, 24), 1)  # Right whisker
